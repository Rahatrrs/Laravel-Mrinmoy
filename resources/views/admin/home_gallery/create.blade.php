...
<div class="col-lg-12">
    <div class="card card-default">
        <div class="card-header card-header-border-bottom">
            <h2>Create Home Gallery</h2>
        </div>
        <div class="card-body">
            <form method="POST" action="{{route('store.home_gallery')}}" enctype="multipart/form-data">
                @csrf
                ...
                <div class="form-group">
                        ...
                        <div class="form-group">
                            <label style="color: rgb(185, 163, 35);" for="image4" class="form-label">Image 4</label>
