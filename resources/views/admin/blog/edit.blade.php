...
<div class="col-lg-12">
    <div class="card card-default">
        ...
        <div class="card-body">
            <form method="POST" action="{{url('blog/update/'.$blogs->id)}}" enctype="multipart/form-data">
                @csrf
                <div class="form-group">
                    <label for="exampleFormControlInput1">Blog Title</label>
                    <input type="text" name="title" class="form-control" id="exampleFormControlInput1" placeholder="Blog Title" value="{{$blogs->title}}">
                    @error('title')
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control" name="content" id="exampleFormControlTextarea1" rows="3">{{$blogs->content}}</textarea>
                    @error('content')
                        <span class="text-danger">{{$message}}</span>
                    @enderror
                </div>
                ...
                <div class="form-group">
                        ...
                        <div class="new" style="border: 1px solid lightgray; padding: 4px; margin-bottom: 5px;">
                            <h5>Old Images</h5>
                            <img src="{{asset($blogs->image1)}}" style="height: 80px"  alt="">
                        ...
                        <div class="new" style="border: 1px solid lightgray; padding: 4px; margin-bottom: 5px;">
                            <h5>Old Images</h5>
                            <img src="{{asset($blogs->image2)}}" style="height: 80px"  alt="">
                        ...
                        <div class="new" style="border: 1px solid lightgray; padding: 4px; margin-bottom: 5px;">
                            <h5>Old Images</h5>
                            <img src="{{asset($blogs->image3)}}" style="height: 80px"  alt="">
