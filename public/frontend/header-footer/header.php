...
<html class="no-js" lang="zxx">
  ...
  <head>
    ...
    <link rel="stylesheet" href="css/font-awesome.min.css"> <!-- Simple Line Icons -->
    <link rel="stylesheet" href="css/simple-line-icons.min.css"> <!-- Themify Icons -->
    <link rel="stylesheet" href="css/themify-icons.css"> <!-- Owl Slider -->
    <link rel="stylesheet" href="css/owl.carousel.min.css">
    <link rel="stylesheet" href="css/owl.theme.default.min.css"> <!-- Magnific Popup -->
    <link rel="stylesheet" href="css/magnific-popup.css"> <!-- Revolution Slider -->
    <link rel="stylesheet" type="text/css" href="rs-plugin/fonts/pe-icon-7-stroke/css/pe-icon-7-stroke.css"> <!-- REVOLUTION STYLE SHEETS -->
    <link rel="stylesheet" type="text/css" href="rs-plugin/css/settings.css">
    <link rel="stylesheet" type="text/css" href="rs-plugin/css/main-slider/rs6.css"> <!-- Color Panel -->
    <link href="css/color_panel.css" rel="stylesheet" type="text/css" /> <!-- Color Panel -->
    <link href="css/color_panel.css" rel="stylesheet" type="text/css" />
    <link rel="stylesheet" href="css/color-schemes/red.css" id="changeable-colors"> <!-- Main Style -->
  ...
  <body data-res-from="1025">
    ...
    <div class="zmm-wrapper"> <a href="#" class="zmm-close close"></a>
      <div class="zmm-inner bg-white typo-dark">
        <div class="text-center mobile-logo-part margin-bottom-30"> <a href="index.php" class="img-before"><img src="./mrinmoy/new.png" class="img-fluid changeable-dark" width="170" height="51" alt="Logo"></a> </div>
                ...
                <div class="sticky-head">
                  <div class="basic-container clearfix">
                    ...
                    <ul class="nav mobile-header-items pull-center">
                      <li> <a href="index.php" class="img-before"><img src="./mrinmoy/new.png" class="img-fluid changeable-dark" width="149" height="45" alt="Logo"></a> </li>
                    </ul>
          ...
          <div class="header-inner header-1 header-absolute">
            ...
            <div class="topbar relative">
              ...
              <div class="full-view-wrapper hide"> <a href="#" class="close full-view-close"></a>
                <form class="navbar-form search-form" role="search"  action="search.php" method="get">
                  <div class="input-group"> <input class="form-control" placeholder="Search hit enter.." name="q" type="text" type="submit"> </div>
                </form>
              </div>
            </div>
            <!--Topbar-->
                  ...
                  <div class="basic-container clearfix">
                    <div class="">
                      ...
                      <ul class="nav navbar-items pull-left">
                        <li class="list-item"> <a href="index.php" class="logo-general"><img src="./mrinmoy/new.png" class="img-fluid changeable-light" width="166" height="50" alt="Logo" /></a> <a href="index.php" class="logo-sticky"><img src="./mrinmoy/new.png" class="img-fluid changeable-dark" width="166" height="50" alt="Logo" /></a> </li>
                      </ul> <!-- Menu -->
                      <ul class="nav navbar-items pull-right">
                        ...
                        <li class="list-item">
                          ...
                          <div class="header-navbar-text-1"><a href="index.php" class="h-donate-btn">প্রথম পাতা</a></div>
                        </li>
                        ...
                        <li class="list-item" style="padding-top: 34px">
                              ...
                              <ul class="dropdown-menu">
                                ...
                                <li> <a href="blog-details-1.php">শিক্ষা সহায়তা</a> </li>
                                <li> <a href="blog-details-4.php">মৃন্ময় পদক প্রদান</a> </li>
                                <li> <a href="blog-details-8.php">বৃক্ষ রোপন কর্মসূচি</a> </li>
                                <li> <a href="blog-details-7.php">ঈদ সামগ্রী বিতরণ</a> </li>
                                <li> <a href="blog-details-9.php">মানুষ মানুষের জন্য প্রকল্প</a> </li>
                            ...
                            <li class="list-item" style="padding-top: 34px">
                          <div class="header-navbar-text-1"><a href="comitee.php" class="h-donate-btn">কমিটি</a></div>
                        </li>
                            ...
                            <li class="list-item" style="padding-top: 34px">
                          <div class="header-navbar-text-1"><a href="team.php" class="h-donate-btn">সদস্য</a></div>
                        </li>
                            
                            <li class="list-item" style="padding-top: 34px">
                          <div class="header-navbar-text-1"><a href="all-blogs.php" class="h-donate-btn">বার্তা</a></div>
                        </li>


                        <li class="list-item" style="padding-top: 34px">
                          <div class="header-navbar-text-1"><a href="gallery.php" class="h-donate-btn">গ্যালারী</a></div>
                        </li>
                            
                            <li class="list-item" style="padding-top: 34px">
                          <div class="header-navbar-text-1"><a href="contact-us.php" class="h-donate-btn">যোগাযোগ</a></div>
                        </li>
                          </ul>
                        </li>
                        <!--List Item End-->
